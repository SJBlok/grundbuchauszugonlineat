...
function generateReportHtml(reportDate: string, orders: any[], totalRevenue: number): string {
  const ordersTableRows = orders.length > 0 
    ...
    `).join('')
    : `<tr><td colspan="6" style="padding: 24px; text-align: center; color: ${BRAND_COLORS.textMuted}; font-size: 14px;">Keine Bestellungen an diesem Tag</td></tr>`;
  ...
  <div style="max-width: 700px; margin: 0 auto; padding: 40px 20px;">
    <div style="background-color: ${BRAND_COLORS.background}; border-radius: 4px; border: 1px solid ${BRAND_COLORS.border};">
      ...
      <div style="padding: 40px;">
          ...
          <tr>
            <td style="width: 50%; padding-right: 12px;">
              <div style="background-color: ${BRAND_COLORS.surface}; border: 1px solid ${BRAND_COLORS.border}; border-radius: 4px; padding: 20px; text-align: center;">
                ...
                <p style="margin: 0; font-size: 13px; color: ${BRAND_COLORS.textMuted}; text-transform: uppercase; letter-spacing: 0.5px;">Bestellungen</p>
              </div>
            </td>
            <td style="width: 50%; padding-left: 12px;">
              <div style="background-color: ${BRAND_COLORS.surface}; border: 1px solid ${BRAND_COLORS.border}; border-radius: 4px; padding: 20px; text-align: center;">
                <p style="margin: 0 0 4px 0; font-size: 32px; font-weight: 600; color: ${BRAND_COLORS.primary};">${formatCurrency(totalRevenue)}</p>
                <p style="margin: 0; font-size: 13px; color: ${BRAND_COLORS.textMuted}; text-transform: uppercase; letter-spacing: 0.5px;">Umsatz</p>
              </div>
            </td>
          </tr>
        </table>
        ...
        <!-- Orders Table -->
        <p style="margin: 0 0 16px 0; font-size: 13px; font-weight: 500; color: ${BRAND_COLORS.text}; text-transform: uppercase; letter-spacing: 0.5px;">Bestellübersicht</p>
        <table role="presentation" cellspacing="0" cellpadding="0" border="0" width="100%" style="border: 1px solid ${BRAND_COLORS.border}; border-radius: 4px; overflow: hidden;">
          <thead>
            <tr style="background-color: ${BRAND_COLORS.surface};">
              <th style="padding: 12px 16px; text-align: left; font-size: 12px; font-weight: 500; color: ${BRAND_COLORS.textMuted}; text-transform: uppercase; letter-spacing: 0.5px; border-bottom: 1px solid ${BRAND_COLORS.border};">Bestellnr.</th>
              <th style="padding: 12px 16px; text-align: left; font-size: 12px; font-weight: 500; color: ${BRAND_COLORS.textMuted}; text-transform: uppercase; letter-spacing: 0.5px; border-bottom: 1px solid ${BRAND_COLORS.border};">Kunde</th>
              ...
              <th style="padding: 12px 16px; text-align: right; font-size: 12px; font-weight: 500; color: ${BRAND_COLORS.textMuted}; text-transform: uppercase; letter-spacing: 0.5px; border-bottom: 1px solid ${BRAND_COLORS.border};">Betrag</th>
      ...
      <div style="background-color: ${BRAND_COLORS.surface}; padding: 28px 40px; text-align: center; border-top: 1px solid ${BRAND_COLORS.borderLight}; border-radius: 0 0 4px 4px;">
        <p style="margin: 0; font-size: 12px; color: ${BRAND_COLORS.textMuted}; line-height: 1.8;">
          Automatisch gegenereerd door GrundbuchauszugOnline.at
        </p>
